...
public class MenuFrame extends javax.swing.JFrame {
    ...
    private final User loggedUser; // Guardamos el usuario que inició sesión
    ...
    public MenuFrame(User user) {
        ...
        // Ejemplo: Cambiar un título con el nombre del usuario
        if (loggedUser != null) {
            this.setTitle("Piedrazul - Sesión de: " + loggedUser.getFirstName());
            // to do: jLabel para el nombre
            // lblBienvenida.setText("Bienvenido, " + loggedUser.getFullName());
        }
    }
