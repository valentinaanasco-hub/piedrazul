...
public class PostgreSQLConnection {
    ...
    private static void initDatabase(Connection conn) {
        String[] sqlStatements = {
            ...
            // 6. Intermedia Doctor_Specialties
            ...
            // 8. Horarios de médicos
            "CREATE TABLE IF NOT EXISTS doctor_schedules ("
            + "sched_id SERIAL, sched_doctor_id INTEGER NOT NULL, "
            + "sched_day_of_week INTEGER NOT NULL, sched_start_time TIME NOT NULL, "
            + "sched_end_time TIME NOT NULL, sched_interval_minutes INTEGER NOT NULL, "
