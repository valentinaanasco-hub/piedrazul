...
/**
 * Seguridad del configuration-service como OAuth2 Resource Server.
 * Valida el JWT y restringe todos los endpoints de configuración al rol ADMIN.
 */
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/configuration/**").hasAnyRole("ADMIN", "DOCTOR", "AGENDADOR")
                .requestMatchers("/api/v1/configuration/**").hasRole("ADMIN")
